...
<template>
  <div class="layout">
    <ReviewerSidebar />
    <div class="main-area">
      <AppTopbar page-title="Riwayat Review" user-name="Inna" user-role="Reviewer" />
      <div class="card"><ComingSoon title="Riwayat Review" icon="history" /></div>
    </div>
  </div>
</template>
<style scoped>
.layout { display: flex; min-height: 100vh; background: linear-gradient(135deg,#f0ebe3,#e8ddd0); }
.main-area { margin-left: 210px; flex: 1; padding: 20px 24px; }
