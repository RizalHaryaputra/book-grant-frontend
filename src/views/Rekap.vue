          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="flex flex-col gap-1 px-1">
                <h3 class="text-[13px] font-extrabold text-[#1C1209] group-hover:text-[#4E3629] transition-colors duration-200 leading-snug">
                  {{ item.title }}
                </h3>
                <div class="flex items-center gap-1.5 text-[11px] text-[#8F8073] font-semibold mt-0.5">
                  <span>{{ item.author }}</span>
                  <span class="w-1 h-1 rounded-full bg-[#8F8073]/30"></span>
                  <span>{{ item.type }}</span>
                </div>
                <p class="text-[10px] text-[#A19489] font-medium mt-0.5">
                  {{ item.timeAgo }}
                </p>
              </div>
